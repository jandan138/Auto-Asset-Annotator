...
def main():
    ...
    parser.add_argument(
        "--output_dir", required=True, help="Directory containing annotation outputs"
    )
    parser.add_argument(
        "--analyze-only",
        action="store_true",
    ...
    parser.add_argument("--save_list", help="Save list of failed assets to file")
    parser.add_argument(
        "--filter_type",
    ...
    print(
        f"      --asset_list_file {args.save_list or 'archive/temp_lists/failed_assets.txt'} \\"
    )
