    ...
    def compose_user_prompt(  # 定义生成用户提示词的方法
        ...
        if prompt_type == "find_canonical_front_view_prompt":  # 如果是寻找标准正视图提示词
            ...
            attribute_query = (
                ...
                "Dimensions: length * width * height as numbers only WITHOUT units (e.g., 0.25 * 0.25 * 0.05). Do not include 'm', 'meters', or any unit text.\n"
                "Mass: mass as a number only WITHOUT units (e.g., 0.5). Do not include 'kg', 'kilograms', or any unit text.\n"
